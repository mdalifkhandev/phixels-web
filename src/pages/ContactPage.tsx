...
export function ContactPage() {
  ...
  useEffect(() => {
    apiService
      ...
      .catch((err) =>
        console.error("Error fetching about content for contact page:", err),
      );
  }, []);
  ...
  const validateForm = () => {
    ...
    if (
      !formData.phone.trim() ||
      !validatePhone(formData.phone, selectedCountry.country)
    )
      newErrors.phone = "Valid phone number required for selected country";
  ...
  return (
    <main className="bg-[#050505] min-h-screen pt-48 pb-20 overflow-hidden">
      {/* Background Effects */}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className={`w-full bg-white/5 border rounded-xl px-4 py-3 text-white focus:outline-none transition-colors ${errors.name ? "border-red-500 focus:border-red-500" : "border-white/10 focus:border-[color:var(--bright-red)]"}`}
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className={`w-full bg-white/5 border rounded-xl px-4 py-3 text-white focus:outline-none transition-colors ${errors.email ? "border-red-500 focus:border-red-500" : "border-white/10 focus:border-[color:var(--bright-red)]"}`}
                    ...
                    <div className="flex gap-2">
                      <div className="relative">
                        <button
                          ...
                          className="h-full bg-white/5 border border-white/10 rounded-xl px-3 py-3 text-white focus:outline-none transition-colors flex items-center gap-2 hover:border-white/20"
                        >
                        ...
                        {showCountryDropdown && (
                          <div className="absolute top-full left-0 mt-2 w-64 max-h-60 overflow-y-auto bg-[#0A0A0A] border border-white/10 rounded-lg shadow-2xl z-50">
                            <input
                              type="text"
                      ...
                      <input
                        ...
                        className={`flex-1 bg-white/5 border rounded-xl px-4 py-3 text-white focus:outline-none transition-colors ${errors.phone ? "border-red-500 focus:border-red-500" : "border-white/10 focus:border-[color:var(--bright-red)]"}`}
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      rows={5}
                      className={`w-full bg-white/5 border rounded-xl px-4 py-3 text-white focus:outline-none transition-colors resize-none ${errors.message ? "border-red-500 focus:border-red-500" : "border-white/10 focus:border-[color:var(--bright-red)]"}`}
            ...
            <div className="grid grid-cols-1 gap-6">
              {[
                ...
                },
                {
                  ...
                  label: "Visit Us",
                  value:
                    contact?.address || "112/2 Mohakhali, Dhaka, Bangladesh",
                  href: "#",
                ...
                >
                  <div
                    className={`w-14 h-14 rounded-xl ${item.bgColor} flex items-center justify-center ${item.color} group-hover:scale-110 transition-transform`}
                  >
                    {item.icon ? (
