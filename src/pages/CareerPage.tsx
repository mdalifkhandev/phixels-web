      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
          {[
            ...
            >
              <div
                className={`w-12 h-12 rounded-lg bg-white/5 flex items-center justify-center mb-6 ${perk.color} group-hover:scale-110 transition-transform`}
              >
                <perk.icon size={24} />
              </div>
            ...
            <div className="space-y-4">
              {roles.map((role, i) => (
                ...
                >
                  <Link
                    to={`/career/${role._id}`}
                    className="flex flex-col md:flex-row md:items-center justify-between p-6 bg-white/5 rounded-xl border border-white/10 hover:border-[color:var(--bright-red)] hover:bg-white/[0.07] transition-all group"
                  >
                    ...
                    <Button
                      variant="outline"
                      className="group-hover:bg-[color:var(--bright-red)] group-hover:text-white group-hover:border-[color:var(--bright-red)] transition-all"
                    >
                      Apply Now{" "}
                      <ArrowRight
                        size={16}
