  ...
  return (
    <main className="bg-[#050505] min-h-screen pt-40 pb-20">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[color:var(--bright-red)] rounded-full mix-blend-screen filter blur-[100px] opacity-10 animate-pulse"
          style={{
            animationDelay: "1s",
          }}
        />
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          {loading ? (
          ...
          ) : content?.privacyPolicy && content.privacyPolicy.length > 0 ? (
            <motion.div
              initial={{
                opacity: 0,
                y: 20,
            ...
            >
              {content.privacyPolicy.map((section, index) => (
                <motion.div
                  key={index}
                ...
                >
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center group-hover:border-[color:var(--bright-red)]/30 transition-colors">
                      <span className="text-xl font-bold text-[color:var(--bright-red)]">
                        {index + 1}
                      </span>
                    </div>
            ...
            /* Fallback static content/message if no policy configured yet */
            <div className="text-center py-20 bg-white/5 border border-white/10 rounded-2xl">
              <Shield className="w-12 h-12 text-gray-500 mx-auto mb-4" />
              <h3 className="text-xl font-medium text-white mb-2">
                Policy Currently Updating
              </h3>
