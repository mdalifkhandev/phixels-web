        ...
        {loading ? (
          ...
          <div className="space-y-8">
            {services.map((service, index) => {
              const Icon =
                iconMap[(service.iconKey || "").toLowerCase()] || Code;
              ...
              return (
                ...
                >
                  {/* Main Service Card */}
                  <div
                    className="group relative rounded-3xl bg-white/5 border border-white/10 overflow-hidden hover:border-white/20 transition-all duration-300 cursor-pointer"
                    onClick={() =>
                      setExpandedService(
                  ...
                  >
                    ...
                    <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
                      {/* Icon */}
                      <div
                        className={`w-24 h-24 rounded-2xl bg-gradient-to-br ${color} flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300`}
                      >
                      ...
                      <div className="flex-1 text-center md:text-left">
                        ...
                        <p className="text-gray-400 text-lg mb-4">
                          Explore our specialized {service.name.toLowerCase()}{" "}
                          solutions for scalable business growth.
                        </p>
                        <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                          <span className="text-sm text-gray-500 font-medium">
                            {service.subcategories?.length || 0} specialized
                            services
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-4">
                        <Link
                          ...
                          className="px-6 py-3 rounded-lg bg-[color:var(--bright-red)] text-white font-bold hover:bg-[color:var(--bright-red)]/90 transition-colors flex items-center gap-2"
                        >
                        ...
                        {(service.subcategories || []).map((sub, idx) => {
                          return (
                            ...
                            >
                              ...
                              <ArrowRight
                                size={16}
                                className="text-gray-500 opacity-0 group-hover/sub:opacity-100 transition-opacity"
                              />
                            </Link>
                          );
                        })}
