...
export function PortfolioTeaser() {
  ...
  const apps = [
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-12 h-12 rounded-xl ${tx.bg} ${tx.text} flex items-center justify-center text-lg font-bold shadow-sm`}
                    >
                      {tx.icon}
                    </div>
                    <div>
                  ...
                  <div
                    className={`text-sm font-bold ${tx.amount.startsWith("+") ? "text-green-600" : "text-gray-900"}`}
                  >
                    {tx.amount}
                  </div>
                </div>
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col h-full bg-slate-50 text-gray-900 font-sans">
        ...
        <div className="flex flex-col h-full bg-white text-gray-900 font-sans">
          ...
          <div className="px-6 mb-6">
            <div className="relative">
              ...
              <input
                type="text"
                className="w-full bg-gray-50 border-none rounded-full py-3 pl-12 pr-4 text-sm font-medium placeholder:text-gray-400 focus:ring-2 focus:ring-black/5"
          ...
          <div className="px-6 mb-6">
            <div className="flex gap-3 overflow-x-auto pb-2 no-scrollbar">
              {["All", "Clothing", "Shoes", "Bags"].map((cat, i) => (
                <button
                  key={i}
                  className={`px-5 py-2 rounded-full text-xs font-bold whitespace-nowrap transition-colors ${i === 0 ? "bg-black text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}
                >
                  {cat}
                </button>
              ))}
          ...
          <div className="pl-6 mb-6">
            <div className="flex gap-4 overflow-x-auto pb-2 no-scrollbar pr-6">
              {[
                ...
                >
                  <div
                    className={`w-16 h-16 rounded-full p-[2px] ${story.active ? "bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500" : "bg-gray-800"}`}
                  >
          ...
          <div className="px-6 mb-6">
            <div className="bg-orange-500 rounded-3xl p-6 text-white relative overflow-hidden shadow-lg shadow-orange-200">
              ...
              <img
                ...
                alt="Pizza"
                className="absolute -right-2 bottom-2 w-28 h-28 object-cover rounded-full shadow-lg border-2 border-white/20"
              />
            </div>
          </div>
  ...
  return (
    <section ref={targetRef} className="h-[300vh] bg-[#050505] relative">
      <div className="sticky top-0 flex h-screen items-center overflow-hidden">
        ...
        <motion.div
          className="absolute top-10 left-4 md:left-10 z-10 max-w-xl"
          initial={{
            opacity: 1,
            y: 0,
          }}
                ...
                <div className="absolute inset-0 rounded-[3.5rem] bg-[#1a1a1a] p-[3px] shadow-[0_0_0_2px_#333,0_20px_60px_-10px_rgba(0,0,0,0.9)] group-hover:shadow-[0_0_0_2px_rgba(237,31,36,0.5),0_30px_80px_-10px_rgba(237,31,36,0.2)] transition-all duration-500">
                  ...
                  <div className="w-full h-full rounded-[3.3rem] bg-black p-[8px] relative overflow-hidden">
                    ...
                    <div className="w-full h-full rounded-[2.8rem] overflow-hidden relative bg-white backface-hidden">
                      ...
                      <div className="absolute top-3.5 left-8 text-[10px] font-bold z-40 mix-blend-difference text-white">
                        9:41
                      </div>
