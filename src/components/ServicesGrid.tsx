...
export function ServicesGrid() {
  ...
  return (
    <section className="py-24 bg-[#050505] relative lg:mt-14 overflow-hidden">
            ...
            return (
              ...
              >
                <Link
                  ...
                  className="group relative block h-full p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-[color:var(--neon-yellow)] transition-all duration-500 overflow-hidden hover:-translate-y-2"
                >
                  <div
                  ...
                  <div
                    className={`relative w-14 h-14 rounded-xl bg-white/5 flex items-center justify-center mb-6 ${color} group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}
                  >
                    <Icon size={32} />
                  </div>
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-400 leading-relaxed text-sm group-hover:text-gray-300 transition-colors">
                      {service.subcategories?.length || 0} specialized services
                      available.
                    </p>
                  </div>
                </Link>
