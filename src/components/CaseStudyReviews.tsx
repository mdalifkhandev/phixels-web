  ...
  return (
    <section className="py-24 bg-[#050505] overflow-hidden relative">
      ...
      <div className="relative w-full overflow-hidden">
        ...
        >
          {[...reviews3, ...reviews3, ...reviews3].map((review, index) => (
            <motion.div
              key={`${review.id}-${index}`}
              className="flex-shrink-0 w-[380px] md:w-[420px] p-8 rounded-2xl bg-[#0A0A0A] border border-white/10 backdrop-blur-sm relative group cursor-pointer"
              whileHover={{
                scale: 1.02,
                y: -4,
              }}
              ...
              <div className="flex items-center gap-1 mb-6">
                {[...Array(review.rating)].map((_, i) => (
                  ...
                  >
                    <Star
                      size={18}
                      className="fill-[color:var(--neon-yellow)] text-[color:var(--neon-yellow)]"
                    />
                  </motion.div>
                ))}
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="relative">
                  ...
                  <img
                    src={review.image}
                    alt={review.name}
                    className="relative w-14 h-14 rounded-full object-cover border-2 border-transparent"
                    style={{
                      background:
                        "linear-gradient(135deg, var(--bright-red), var(--neon-yellow), var(--vibrant-green))",
                      padding: "2px",
                    }}
                  />
                </div>
