...
export const Review = [
  ...
  },
  {
    ...
    rating: 5,
    review:
      "Their strategic approach to our SaaS platform redesign was impressive. Not only did they modernize our interface, but they also improved our user retention by 67%. The team's expertise in both design and development is truly world-class.",
    project: "SaaS Platform Redesign & Optimization",
    budget: "$28,500",
    duration: "2.5 months",
    summary:
      "Complete UI/UX overhaul with modern design system, performance optimization, new onboarding flow, and integration of advanced analytics features.",
  },
  {
    name: "David Park",
    role: "CTO, HealthTech Solutions",
    ...
    rating: 5,
    review:
      "Building a HIPAA-compliant healthcare platform required expertise and precision. This team delivered both flawlessly. The system handles thousands of patient records securely, and our clients trust it completely. Outstanding work from start to finish.",
    project: "Healthcare Management System",
    budget: "$48,000",
    duration: "5 months",
    summary:
      "HIPAA-compliant patient management platform with secure data encryption, appointment scheduling, telemedicine integration, and comprehensive reporting tools.",
  },
  {
    name: "Davis Lee",
    ...
    rating: 5,
    review:
      "The logistics tracking system they developed revolutionized our operations. Real-time tracking, automated reporting, and intuitive dashboards have saved us countless hours. Their technical expertise and project management were exceptional throughout.",
    project: "Logistics & Supply Chain Platform",
    budget: "$38,500",
    duration: "4 months",
    summary:
      "Real-time logistics tracking system with GPS integration, automated inventory management, route optimization, and comprehensive analytics dashboard.",
  },
  {
    name: "Robert Anderson",
    role: "Director, EduTech Academy",
    ...
    rating: 5,
    review:
      "Our online learning platform needed to scale to support 50,000+ students. They architected a solution that's not only robust but also incredibly user-friendly. Student engagement increased by 89%, and our instructors love the new tools.",
    project: "Online Learning Management System",
    budget: "$45,000",
    duration: "4.5 months",
    summary:
      "Scalable LMS with video streaming, interactive assessments, progress tracking, discussion forums, and comprehensive course management tools.",
  },
  {
    name: "Amanda Foster",
    role: "Founder, StyleHub",
    ...
    rating: 5,
    review:
      "The fashion marketplace they created is stunning and functional. The AR try-on feature they implemented was a game-changer for our business. Sales increased by 210% in the first six months. Truly innovative work.",
    project: "Fashion E-commerce with AR Features",
    budget: "$32,000",
    duration: "3.5 months",
    summary:
      "Modern e-commerce platform with AR virtual try-on, personalized recommendations, social shopping features, and seamless checkout experience.",
  },
  {
    name: "James Wilson",
    ...
    rating: 5,
    review:
      "Our real estate platform needed sophisticated search capabilities and virtual tour integration. They delivered beyond expectations. The 3D property tours and AI-powered matching system have set us apart from competitors. Exceptional quality.",
    project: "Real Estate Platform with Virtual Tours",
    budget: "$41,500",
    duration: "4 months",
    summary:
      "Comprehensive real estate platform with 3D virtual tours, advanced property search, AI-powered matching, mortgage calculator, and agent management system.",
  },
];
...
export const reviews3 = [
  {
    ...
    content:
      "The attention to detail and technical expertise Phixels brought to our project was unmatched. They didn't just build a product; they engineered a solution.",
    rating: 5,
  },
  {
    id: 2,
    ...
    content:
      "Incredible workflow and communication. The team felt like a true extension of our own. The final delivery exceeded all our expectations.",
    rating: 5,
  },
  {
    id: 3,
    ...
    content:
      "We've worked with many agencies, but Phixels stands out. Their design-first approach combined with robust engineering is a game changer.",
    rating: 5,
  },
  {
    id: 4,
    ...
    content:
      "Professional, timely, and incredibly talented. They transformed our vague requirements into a polished, market-ready platform.",
    rating: 5,
  },
  {
    id: 5,
    ...
    content:
      "The ROI we've seen since launching the new platform has been phenomenal. Phixels understands both business goals and user needs.",
    rating: 5,
  },
  {
    id: 6,
    ...
    content:
      "Clean code, scalable architecture, and stunning UI. It's rare to find a team that excels at both frontend and backend so seamlessly.",
    rating: 5,
  },
  {
    id: 7,
    ...
    content:
      "They helped us rebrand and launch in record time. The feedback from our customers has been overwhelmingly positive.",
    rating: 5,
  },
  {
    id: 8,
    ...
    content:
      "A partnership that truly drives value. Phixels is not just a vendor; they are strategic partners in our success story.",
    rating: 5,
  },
];
...
export const featuredPosts = [
  {
    ...
    excerpt:
      "How artificial intelligence is revolutionizing the way we build and interact with mobile applications.",
    category: "AI & ML",
    date: "Jan 15, 2026",
    readTime: "5 min",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Best practices for designing and implementing microservices that can handle millions of users.",
    category: "Software",
    date: "Jan 12, 2026",
    readTime: "8 min",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Understanding blockchain technology and how it's reshaping the internet as we know it.",
    category: "Blockchain",
    date: "Jan 10, 2026",
    readTime: "6 min",
    image:
...
export const cases = [
  ...
  },
  {
    ...
    solution:
      "HIPAA-compliant video consultation platform with EMR integration.",
  ...
  },
  {
    ...
    solution:
      "Machine learning recommendation engine with behavioral analysis.",
  ...
  },
  {
    ...
    solution:
      "Real-time fraud detection using deep learning and behavioral patterns.",
  ...
  },
  {
    ...
    solution:
      "AI-powered adaptive learning paths with real-time progress tracking.",
  ...
  },
  {
    ...
    solution:
      "IoT-based smart grid with predictive maintenance and load balancing.",
  ...
  },
  {
    ...
    solution:
      "AI-driven dynamic pricing based on demand, seasonality, and competition.",
  ...
  },
  {
    ...
    solution:
      "IoT sensors with ML models predicting failures before they occur.",
  ...
  },
  {
    ...
    solution:
      "3D virtual tours with VR support and AI-powered property matching.",
...
export const jobsData = {
  1: {
    ...
    salary: "$80k - $120k",
    description:
      "We are looking for a Senior React Native Engineer to join our mobile development team. You will be responsible for building high-performance, scalable mobile applications that serve millions of users worldwide.",
    requirements: [
  ...
  2: {
    ...
    salary: "$90k - $140k",
    description:
      "Join our backend team as a Backend Architect specializing in Node.js and Go. You will design and implement scalable, secure, and high-performance backend systems that power our mobile and web applications.",
    requirements: [
  ...
  3: {
    ...
    salary: "$60k - $90k",
    description:
      "We are seeking a Senior UI/UX Designer to create exceptional user experiences for our mobile and web applications. You will work closely with our development team to design intuitive, beautiful, and user-friendly interfaces.",
    requirements: [
  ...
  4: {
    ...
    salary: "$70k - $100k",
    description:
      "As a Technical Project Manager, you will oversee the planning, execution, and delivery of complex software projects. You will bridge the gap between technical teams and stakeholders, ensuring projects are delivered on time and meet quality standards.",
    requirements: [
...
export const servicesData = [
  {
    ...
    description: "Native & Cross-platform solutions for iOS and Android.",
    longDesc:
      "We build world-class mobile applications that deliver seamless user experiences across all devices. From native iOS and Android apps to efficient cross-platform solutions.",
    subcategories: [
      "Mobile App Development",
      "Android App Development",
      "iOS App Development",
  ...
  },
  {
    ...
    description: "Scalable web applications using modern frameworks.",
    longDesc:
      "Create a powerful online presence with our custom web development services. We build fast, secure, and scalable web applications using the latest technologies.",
    subcategories: [
      "Website Development",
      "Laravel Development",
      "eCommerce Development",
  ...
  },
  {
    ...
    description: "Custom software tailored to your business needs.",
    longDesc:
      "Transform your business operations with custom software solutions. We design and develop robust software tailored to your specific enterprise requirements.",
    subcategories: [
      "Software Development",
      "SaaS Development",
      "POS Development",
  ...
  },
  {
    ...
    description: "Intelligent solutions powering the future.",
    longDesc:
      "Leverage the power of Artificial Intelligence to automate processes, gain insights, and create intelligent user experiences.",
    subcategories: [
      "AI Development",
      "AI Chatbot Development",
      "Generative AI Development",
  ...
  },
  {
    ...
    description: "Decentralized apps and smart contract solutions.",
    longDesc:
      "Build the future of decentralized technology with our blockchain expertise. From smart contracts to full-scale dApps and NFT marketplaces.",
    subcategories: [
      "Blockchain Development",
      "Ethereum Development",
      "Metaverse Development",
  ...
  },
  {
    ...
    description: "Robust solutions for large-scale organizations.",
    longDesc:
      "Scale your enterprise with our comprehensive digital solutions. We provide consulting and development for major enterprise platforms.",
    subcategories: [
      "Microsoft Power BI Consulting",
      "Microsoft Azure Consulting",
      "SAP Consulting Services",
  ...
  },
  {
    ...
    description: "Uber-like apps for various service industries.",
    longDesc:
      "Launch your on-demand business quickly with our proven solution frameworks for delivery, booking, and service marketplaces.",
    subcategories: [
      "Food Delivery",
      "Taxi Booking",
      "Grocery Delivery",
